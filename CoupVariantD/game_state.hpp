...
enum Action {
  ...
  COUP = 6,
  BLOCK_FOREIGN_AID = 7,
  BLOCK_STEAL1_AMB = 8,  // Blocked by Ambassador
  BLOCK_STEAL2_AMB = 9,
  BLOCK_STEAL1_CAP = 10, // Blocked by Captain
  BLOCK_STEAL2_CAP = 11,
  BLOCK_ASSASSINATE = 12,
  CHALLENGE = 13,
  PASS_BLOCK = 14,
  SHOW_ASSASSIN = 15,    // Show: Show a challenged card
  SHOW_AMBASSADOR = 16,
  SHOW_CAPTAIN = 17,
  SHOW_CONTESSA = 18,
  SHOW_DUKE = 19,
  LOSE_ASSASSIN = 20,    // Lose: Lose a card
  LOSE_AMBASSADOR = 21,
  LOSE_CAPTAIN = 22,
  LOSE_CONTESSA = 23,
  LOSE_DUKE = 24,
