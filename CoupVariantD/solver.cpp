...
int main() {
    ...
    // std::cout <<  g.current_player << std::endl;
...
//         std::vector<int> card_nums = {3, 3, 3, 3, 3};
...
//                 if (i == c) card_num -= 1;
//                 card_distribution.push_back(card_num / 14.0);
//             }   
...
//                 if (p == 0) {
//                     double v = calculate_best_response(g, p, cards, card_distribution) * (card_nums[c] / 15.0);
//                     p1_br_utility += v;
//                 } else {
//                     double v =  -1 * calculate_best_response(g, p, cards, card_distribution) * (card_nums[c] / 15.0);
//                     p2_br_utility += v;
//                 }
//             }
//         }
